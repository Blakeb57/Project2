...
int menu()
{
	...
	cout << "3 - Walk through the list, one friend at a time. " << endl;
	cout << "4 - Sort your friends by birthday. " << endl;
...
{
	int ans;
	cout << "What would like to do with this friend? " << endl;
	cout << "1 - Remove from the list. " << endl;
	cout << "2 - Insert a new friend or cut-out friend before this friend. " << endl;
	cout << "3 - Put a new friend or cut-out friend after this friend. " << endl;
	cout << "4 - Cut this friend from the list to be inserted elsewhere. " << endl;
	cout << "    If you want the friend earlier in the list you will need to start a new walk-through. " << endl;
	cout << "5 - Advance to the next friend. " << endl;
